        ...
        return (
            <form method="post" onSubmit={this.submitForm} id="cf-1" className="contact-form">
                <div className="form-group form-group-lg">
                    <p className="input-group gutter-width-sm no-space">
                        <span className="gutter-width">
                            <label className="form-label-lg before after mb-0" htmlFor="cf-1-name-surename" style={{ fontFamily: 'Encode' }} >Name</label>

                            <input style={{ fontFamily: 'Encode' }} name="name"
                        ...
                        <span className="gutter-width">
                            <label className="form-label-lg before after mb-0" htmlFor="cf-1-services" style={{ fontFamily: 'Encode' }}>Choose a service *</label>

                            <select style={{ fontFamily: 'Encode' }} name="services"
                                id="cf-1-services"
                                value={this.state.values.services}
                                onChange={this.handleInputChange}>
                                <option value="hair-treatments">Hair Cut</option>
                                <option value="face-and-body">Hair Color</option>
                                <option value="hands-feets">Hair Cut and Color</option>
                                <option
                                    value="haircuts-for-men">Other</option>
                            </select>
                        </span>
                    </p>
                </div>
                ...
                <div className="form-group form-group-lg">
                    <p className="input-group gutter-width-sm no-space">
                        <span className="gutter-width">
                            <label className="form-label-lg before after mb-0" htmlFor="cf-1-phone" style={{ fontFamily: 'Encode' }}>Your phone number *</label>

                            <input style={{ fontFamily: 'Encode' }} name="phone"
                        ...
                        <span className="gutter-width">
                            <label style={{ fontFamily: 'Encode' }} className="form-label-lg before after mb-0" htmlFor="cf-1-date">Choose desired date (estimate)</label>
                            <input name="date"
                ...
                <div className="form-group form-group-lg">
                    <label style={{ fontFamily: 'Encode' }} className="form-label-lg before after mb-0" htmlFor="cf-1-message">Message</label>

                    <textarea style={{ fontFamily: 'Encode' }} name="message"
                ...
                <div className="form-group form-group-lg mb-0">
                    <button style={{ fontFamily: 'Encode' }} type="submit" className="btn btn-outline-secondary">Send Message</button>
                </div>
            </form>
        );
    }
